...
from .views import createOrder,deleteProduct,getProduct,getHistoryOrder,getProductBarcode,putProduct,getFavorites,getSimilarProducts,getNewestProducts,getFirstProducts
urlpatterns = [
    ...
    path("getshopproducts",getFavorites),
